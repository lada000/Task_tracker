...
type TaskServiceClient interface {
	...
	GetTasks(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*TaskListResponse, error)
}
...
func (c *taskServiceClient) GetTasks(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*TaskListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type TaskServiceServer interface {
	...
	GetTasks(context.Context, *Empty) (*TaskListResponse, error)
...
func (UnimplementedTaskServiceServer) GetTasks(context.Context, *Empty) (*TaskListResponse, error) {
